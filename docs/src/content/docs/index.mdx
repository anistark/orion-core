...
![Orion sits between any backend (llama.cpp, MLX, cloud API) and your app, turning a prompt into a streamed, tool-augmented answer.](../../assets/diagrams/orion-core-hero.png)
...
inference engine, and Orion handles everything above it.
...
<CardGrid>
  <Card title="One trait to implement" icon="seti:rust">
    ...
    thread - no async required. Orion owns the async orchestration.
  </Card>
